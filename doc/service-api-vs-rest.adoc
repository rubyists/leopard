...
| Discovery
| Requires external service registry or API gateway
...
| Low-latency binary protocol with optional JSON payloads
...
| Scale Ractor/thread pools + horizontal instances independently
|===
